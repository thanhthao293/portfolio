...
ggplot(stu_long, aes(x = Percentage, fill = Vehicle)) +
  ...
  labs(caption = "Figure 1. Histogram of Vehicle Mode Usage for Commuting by Students",
       x = "Percentage",
       y = "Frequency") +
  theme_minimal() +
...
ggplot(emp_long, aes(x = Percentage, fill = Vehicle)) +
  geom_histogram(binwidth=10, position = "dodge", color = "black") +
  facet_wrap(~ Vehicle, ncol=4, nrow=2) +
  labs(caption = "Figure 2. Histogram of Vehicle Mode Usage for Commuting by Employees",
       x = "Percentage",
       y = "Frequency") +
  theme_minimal() +
  theme(legend.position = "none",
...
ggplot(daily_miles, aes(x=daily_miles_one_way, color=DESIGNATION)) +
  geom_density() +
  labs(caption = "Figure 3. Distribution of One Way Daily Miles Traveled",
